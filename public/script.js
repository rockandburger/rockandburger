...
var _sections = __webpack_require__(7);
...
var _hamburger = __webpack_require__(12);
    ...
    (0, _utils.all)('.section').forEach(function (section) {
        ...
        scroll.init({
            ...
            after: function after(_) {
                ...
                if (section.id === 'contato' && scroll.lastPosY >= (0, _utils.getElemOffset)(section).top - 160) {
                    action(section);
                }
            }
...
var _contactHelpers = __webpack_require__(10);
